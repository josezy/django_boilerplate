"""
Parse staticfiles used by each page and add asset preload headers
to the request, which nginx and/or CloudFlare can use to push staticfiles
upstream to HTTP/2 clients before they're requested.

Inspired by, but not a direct copy of:
