...
from core.view_utils import sanitize_html, ExtendedEncoder
from core.middleware.http2_middleware import record_file_to_preload
...
def json(value):
    """
    safe jsonify filter, bleaches the json string using the b
    leach html tag remover
    """
